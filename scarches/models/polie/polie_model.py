...
from scarches.models.polie.polie import EmbedCVAE
from scarches.trainers.polie import PoLIETrainer


class PoLIE(BaseMixin):
    """Model for PoLIE class. This class contains the methods and functionalities for label transfer and landmark training.
