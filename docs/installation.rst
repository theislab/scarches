...
The list of dependencies for scArches can be found in the `requirements.txt <https://github.com/theislab/scarches/requirements.txt>`_ file in the repository.
